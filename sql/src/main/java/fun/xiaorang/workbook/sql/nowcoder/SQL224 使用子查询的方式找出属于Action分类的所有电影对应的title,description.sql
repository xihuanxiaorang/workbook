...
VALUES (1, 1, '2006-02-14 21:07:09');
INSERT INTO film_category
VALUES (2, 1, '2006-02-14 21:07:09');
INSERT INTO film_category
VALUES (3, 6, '2006-02-14 21:07:09');

# Write your MySQL query statement below
SELECT f.title, f.description
FROM film f
         LEFT JOIN film_category fc on f.film_id = fc.film_id
WHERE fc.category_id IN (SELECT category.category_id FROM category WHERE name = 'Action');